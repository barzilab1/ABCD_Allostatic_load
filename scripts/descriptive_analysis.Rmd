...
## 1.	AL, and 8 components of AL / use label from Figure 2A - Will delete if not included in the Figure 2
...
### Among AFR - Will delete if not included in the Supplement Figure 1
...
CreateTableOne(
  data = dataset_main,
  strata = "genetic_afr",
  vars = c("race_white", "race_black", "ethnicity_hisp"),
  factorVars = c("race_white", "race_black", "ethnicity_hisp"),
  includeNA = F,
  addOverall = F
)
```
