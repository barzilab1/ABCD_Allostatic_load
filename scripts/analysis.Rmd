...
### adj p
round(p.adjust(c(9.299e-10, 8.762e-08, 2.2e-16, 0.02076, 2.2e-16), method = "fdr"), 3) #0.000 0.000 0.000 0.000 0.021 0.000
...
### adj p
round(p.adjust(c(0.003375, 0.05613, 2.2e-16, 0.04071, 2.2e-16), method = "fdr"), 3) # 0.005 0.000 0.053 0.000 0.053 0.000
...
### adj p
round(p.adjust(c(2.2e-16, 2.2e-16, 2.2e-16, 0.003641, 2.2e-16), method = "fdr"), 3) #0.000 0.000 0.000 0.000 0.004 0.000
...
### adj p
round(p.adjust(c(0.0001653, 0.0008835, 2.2e-16, 0.2894, 2.2e-16), method = "fdr"), 3) #0.000 0.000 0.001 0.000 0.295 0.000
```
