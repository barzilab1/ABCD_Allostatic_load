...
tab_model(main_mod_1_whole, main_mod_2_whole, digits.rsq = 4, show.intercept = F)
tab_model(main_mod_1_whole, main_mod_2_whole,
          ...
          file = "../results_paper/tableS3_exposome_AL_091123_WHOLE.xls")
```
...
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_t2d_eur, main_mod_4_t2d_eur, main_mod_5_t2d_eur, 
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE,  
          file = "../results_paper/tableS4.1_GxE_AL_091123_EUR_T2D.xls")

### Supplement table S4 - bottom
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_mdd_eur, main_mod_4_mdd_eur, main_mod_5_mdd_eur, show.intercept = F) 
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_mdd_eur, main_mod_4_mdd_eur, main_mod_5_mdd_eur, 
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS4.2_GxE_AL_091123_EUR_MDD.xls")

# 
# tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_bmi_eur, main_mod_4_bmi_eur, main_mod_5_bmi_eur, 
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table1_GxE_AL_091123_EUR_BMI.xls")
# 
# 
# tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_ptsd_eur, main_mod_4_ptsd_eur, main_mod_5_ptsd_eur, 
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table1_GxE_AL_091123_EUR_PTSD.xls")
```
...
tab_model(main_mod_1_afr, main_mod_2_afr, main_mod_3_t2d_afr, main_mod_4_t2d_afr, main_mod_5_t2d_afr,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE,
          file = "../results_paper/tableS5.1_GxE_AL_091123_AFR_T2D.xls")
...
tab_model(main_mod_1_afr, main_mod_2_afr, main_mod_3_mdd_afr, main_mod_4_mdd_afr, main_mod_5_mdd_afr,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS5.2_GxE_AL_091123_AFR_MDD.xls")

# tab_model(main_mod_1_afr, main_mod_2_afr, main_mod_3_ptsd_afr, main_mod_4_ptsd_afr, main_mod_5_ptsd_afr, 
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table1_GxE_AL_091123_AFR_PTSD.xls")
...
tab_model(main_mod_1_total_BPM, main_mod_2_total_BPM,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS6.1_AL_BPM_091123_WHOLE.xls")
...
tab_model(main_mod_1_total_CBCL, main_mod_2_total_CBCL,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS6.2_AL_CBCL_091123_WHOLE.xls")
...
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table2_AL_intBPM_091123_WHOLE.xls")
...
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table2_AL_extCBCL_091123_WHOLE.xls")
```
...
tab_model(main_mod_1_Zraw_BPM, main_mod_2_Zraw_BPM,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS6.1_AL_BPM_091123_WHOLE_Zscore_rawBPM.xls")
...
tab_model(main_mod_1_Zraw_CBCL, main_mod_2_Zraw_CBCL,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS6.2_AL_CBCL_091123_WHOLE_Zscore_rawCBCL.xls")
```
...
# Rerun supplement table S3 on dataset_2y_sens1
tab_model(get_model(data = dataset_2y_sens1, outcome = "allostatic_load", predictor = "exposome_score_1y"), show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, file = "../results_paper/tableS10_exposome_AL_091123_nonNA.xls")

# Rerun supplement table S3 on dataset_2y_sens2
tab_model(get_model(data = dataset_2y_sens2, outcome = "allostatic_load", predictor = "exposome_score_1y"), show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, file = "../results_paper/tableS11_exposome_AL_091123_atleast1.xls")
```
