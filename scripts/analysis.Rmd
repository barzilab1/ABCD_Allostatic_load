...
tab_model(main_mod_1_whole, main_mod_2_whole,
          ...
          file = "../results_paper/tableS3_exposome_AL_101223_WHOLE.xls")
```
...
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_t2d_eur, main_mod_4_t2d_eur, main_mod_5_t2d_eur, 
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE,  
          file = "../results_paper/tableS4.1_GxE_AL_101223_EUR_T2D.xls")
...
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_mdd_eur, main_mod_4_mdd_eur, main_mod_5_mdd_eur, 
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS4.2_GxE_AL_101223_EUR_MDD.xls")


### Supplement table S12 - top
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_bmi_eur, main_mod_4_bmi_eur, main_mod_5_bmi_eur, 
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE,  
          file = "../results_paper/tableS12.1_GxE_AL_101223_EUR_BMI.xls")

### Supplement table S12 - bottom
tab_model(main_mod_1_eur, main_mod_2_eur, main_mod_3_ptsd_eur, main_mod_4_ptsd_eur, main_mod_5_ptsd_eur, 
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS12.2_GxE_AL_101223_EUR_PTSD.xls")



# Compare the models table S4
## TOP
...
main_mod_4_bmi_eur_2 <- get_model(data = data_eur %>% filter(!is.na(BMI_PRS) & !is.na(exposome_score_1y)), outcome = "allostatic_load", 
                                  predictor = c("exposome_score_1y", "BMI_PRS"), covariates = covar_prs)

main_mod_5_bmi_eur_2 <- get_model(data = data_eur %>% filter(!is.na(BMI_PRS) & !is.na(exposome_score_1y)), outcome = "allostatic_load", 
                                  predictor = "exposome_score_1y*BMI_PRS", covariates = covar_prs)

anova(main_mod_3_bmi_eur, main_mod_1_eur, test="Chisq")
anova(main_mod_3_bmi_eur_2, main_mod_2_eur, test="Chisq")
anova(main_mod_4_bmi_eur_2, main_mod_2_eur, test="Chisq")
anova(main_mod_4_bmi_eur_2, main_mod_3_bmi_eur_2, test="Chisq")
anova(main_mod_5_bmi_eur, main_mod_4_bmi_eur, test="Chisq")
anova(main_mod_5_bmi_eur_2, main_mod_3_bmi_eur_2, test="Chisq")
### adj p
round(p.adjust(c(2.2e-16, 0, 2.2e-16, 2.2e-16, 0.00375, 2.2e-16), method = "fdr"), 3) #0.000 0.000 0.000 0.000 0.004 0.000
...
main_mod_4_ptsd_eur_2 <- get_model(data = data_eur %>% filter(!is.na(PTSD_fromEUR_PRS) & !is.na(exposome_score_1y)), outcome = "allostatic_load", 
                                  predictor = c("exposome_score_1y", "PTSD_fromEUR_PRS"), covariates = covar_prs)

main_mod_5_ptsd_eur_2 <- get_model(data = data_eur %>% filter(!is.na(PTSD_fromEUR_PRS) & !is.na(exposome_score_1y)), outcome = "allostatic_load", 
                                  predictor = "exposome_score_1y*PTSD_fromEUR_PRS", covariates = covar_prs)

anova(main_mod_3_ptsd_eur, main_mod_1_eur, test="Chisq")
anova(main_mod_3_ptsd_eur_2, main_mod_2_eur, test="Chisq")
anova(main_mod_4_ptsd_eur_2, main_mod_2_eur, test="Chisq")
anova(main_mod_4_ptsd_eur_2, main_mod_3_ptsd_eur_2, test="Chisq")
anova(main_mod_5_ptsd_eur, main_mod_4_ptsd_eur, test="Chisq")
anova(main_mod_5_ptsd_eur_2, main_mod_3_ptsd_eur_2, test="Chisq")
### adj p
round(p.adjust(c(0.0001737, 0, 0.0008664, 2.2e-16, 0.2948, 2.2e-16), method = "fdr"), 3) #0.000 0.000 0.001 0.000 0.295 0.000
```
...
tab_model(main_mod_1_afr, main_mod_2_afr, main_mod_3_t2d_afr, main_mod_4_t2d_afr, main_mod_5_t2d_afr,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE,
          file = "../results_paper/tableS5.1_GxE_AL_101223_AFR_T2D.xls")
...
tab_model(main_mod_1_afr, main_mod_2_afr, main_mod_3_mdd_afr, main_mod_4_mdd_afr, main_mod_5_mdd_afr,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS5.2_GxE_AL_101223_AFR_MDD.xls")

# tab_model(main_mod_1_afr, main_mod_2_afr, main_mod_3_ptsd_afr, main_mod_4_ptsd_afr, main_mod_5_ptsd_afr, 
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table1_GxE_AL_101223_AFR_PTSD.xls")
...
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/tableS6.1_AL_BPM_101223_WHOLE.xls")
...
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/tableS6.2_AL_CBCL_101223_WHOLE.xls")
...
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table2_AL_intBPM_101223_WHOLE.xls")
...
#           show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
#           file = "../results_paper/main_table2_AL_extCBCL_101223_WHOLE.xls")
```


## Supplement table S6 - Z scores of raw BPM/CBCL scores
```{r}
...
tab_model(main_mod_1_Zraw_BPM, main_mod_2_Zraw_BPM,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS6.1_AL_BPM_101223_WHOLE_Zscore_rawBPM.xls")
...
tab_model(main_mod_1_Zraw_CBCL, main_mod_2_Zraw_CBCL,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS6.2_AL_CBCL_101223_WHOLE_Zscore_rawCBCL.xls")
```
...
tab_model(sens_mod_10.1, sens_mod_10.2,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS10_exposome_AL_101223_nonNA.xls")
...
tab_model(sens_mod_11.1, sens_mod_11.2,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
          file = "../results_paper/tableS11_exposome_AL_101223_atleast1.xls")
```
