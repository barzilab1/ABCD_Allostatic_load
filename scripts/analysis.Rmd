...
## Supplement table S7 - Z scores of raw BPM/CBCL scores
```{r}
...
sens_mod_11.1 <- get_model(data = dataset_2y_sens1, outcome = "allostatic_load", predictor = "exposome_score_1y", covariates = NULL)
sens_mod_11.2 <- get_model(data = dataset_2y_sens1, outcome = "allostatic_load", predictor = "exposome_score_1y")
...
sens_mod_12.1 <- get_model(data = dataset_2y_sens2, outcome = "allostatic_load", predictor = "exposome_score_1y", covariates = NULL)
sens_mod_12.2 <- get_model(data = dataset_2y_sens2, outcome = "allostatic_load", predictor = "exposome_score_1y")

tab_model(sens_mod_12.1, sens_mod_12.2,
          show.intercept = F, digits.rsq = 4, transform = NULL, auto.label = FALSE, collapse.ci = FALSE, 
