...
mod_t2dPRS_AL_Zbpm_afr$summary
```
...
## Supplement table S13.1: BMI PRS >> AL >> BPM total T scores
```{r}
# EUR
...
## Supplement table S13.2: BMI PRS >> AL >> CBCL total T scores
```{r}
# EUR
...
## Supplement table S13.3: PTSD PRS >> AL >> BPM total T scores
```{r}
# EUR
...
## Supplement table S13.4: PTSD PRS >> AL >> CBCL total T scores
```{r}
# EUR
